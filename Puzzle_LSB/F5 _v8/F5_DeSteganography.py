...
def F5_DeSteganography( in_image_path, out_filename, key,data_bit_count,DeStego_Time_file):        
    ...
    #print('extracted_bits_red_channel[:data_bit_count]:',extracted_bits_red_channel[:data_bit_count])
    ...
    extracted_bits = extracted_bits_red_channel[data_bit_count:] + extracted_bits_green_channel + extracted_bits_blue_channel
