...
#     parser.add_argument("--audio_path", type=str, help="Path to the audio file to be appended")

#     args = parser.parse_args()

#     images_to_video(args.input_folder, args.output_video, args.fps, args.audio_path)
def main():
