...
def F5_Steganography(filename, in_image_path, out_image_path, key, data_bit_count,Stego_Time_file):        
    ...
    bit_array, execution_time0 = read_bin_file_to_bits(filename,Stego_Time_file)
    data_size, execution_time1 = compute_data_size(bit_array[:data_bit_count],Stego_Time_file)
    ...
    (red_channel_scenario, green_channel_scenario, blue_channel_scenario, 
     red_channel_bit_array, green_channel_bit_array, blue_channel_bit_array, Error, execution_time3) = Data_Distributer(bit_array[:data_size], data_size, max_capacity_per_channel,Stego_Time_file)
...
if __name__ == "__main__":
    ...
    Stego_Time_file = "steganography_time_complexity.txt"
