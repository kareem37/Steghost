...
def process_chunk(i, algorithm_pattern, script_paths, key, data_bit_count, output_frames_folder_data, Extracted_Video_Frames, time_complexity_folder):
    file_index = f'{i:05d}'
...
key = 23
data_bit_count = 24
base_folder = r'E:\(4)\GP2024\Final\Steghost\Integration\Video Steganography\Video of Images\DeSteganography'
...
with ThreadPoolExecutor() as executor:
    futures = [
        executor.submit(
            ...
            output_frames_folder_data, Extracted_Video_Frames, time_complexity_folder
...
print("GPU execution_time:", execution_time, "For #", loop_count, "Frames")
